...
def hello():
    ...
    access_token="AAAAAAITEghMBAJXnUmTBnwuBJ149uatf6nbwDReIkkzcKBa5CLZCTWuo5imzSRpWBB46Gy6ZCpGex4I4cVSLRZB7Agoro4jfgTGAivZACwZDZD"
    ...
    return_string = "Your total number of neighbors are : " + str(total_friends) + "<br>" 
    return_string = return_string + "Your total number of neighbor friends are : " + str(total_neighbor_friends) + "<br>" 
    return_string = return_string + "Your clustering coefficient is : " + str( (2*total_neighbor_friends*1.0)/(total_friends*(total_friends - 1)) ) + "<br>"
