...
for i in a:
    if head != 0:
        if int(i.strip().split(' ')[0]) < 1:
            b.write( str(int(i.strip().split(' ')[0]) * -1 ))
        else:
            b.write( str(int(i.strip().split(' ')[0])  + 100000))
        b.write(' ')
        if int(i.strip().split(' ')[1]) < 1:
            b.write( str(int(i.strip().split(' ')[1]) * -1 + 100000))
        else:
            b.write( str(int(i.strip().split(' ')[1])))
        b.write('\n')
        
        if int(i.strip().split(' ')[0]) < 1:
            b.write( str(int(i.strip().split(' ')[0]) * -1 + 100000))
        else:
            b.write( str(int(i.strip().split(' ')[0])  ))
        b.write(' ')
        if int(i.strip().split(' ')[1]) < 1:
            b.write( str(int(i.strip().split(' ')[1]) * -1 ))
        else:
            b.write( str(int(i.strip().split(' ')[1]) + 100000))
        b.write('\n')
    head += 1
b.close()
