...
for i in a:
    if head != 0:
        b.write( str(int(i.strip().split(' ')[0]) * -1) + ' ' + str(int(i.strip().split(' ')[1]) ) + '\n')
        s.append(str(int(i.strip().split(' ')[0]) * -1))
        s.append(str(int(i.strip().split(' ')[1])))
        b.write( str(int(i.strip().split(' ')[0]) ) + ' ' + str(int(i.strip().split(' ')[1]) * -1 ) + '\n')
        s.append(str(int(i.strip().split(' ')[1]) * -1))
        s.append(str(int(i.strip().split(' ')[0])))
    head += 1
b.close()
l1 = set(s)
l = list(l1)
...
print min([int(i) for i in l]), max([int(i) for i in l])
